const __vite__fileDeps=["./vega-embed.module.HeHNNBS_.js","./2.BuoS0npz.js","./preload-helper.DpQnamwV.js","./stores.Bpxql-MD.js","./client.BM2WibkS.js","../assets/2.twp0Ee8v.css","./dsv.CKxpOsHB.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { B as Block, i as BlockTitle, S as Static } from "./2.BuoS0npz.js";
...
function instance($$self, $$props, $$invalidate) {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await __vitePreload(() => import("./vega-embed.module.HeHNNBS_.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0, import.meta.url)).default;
    }
