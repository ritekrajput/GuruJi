...
import { B as Block, S as Static, f as BlockLabel, K as Code$2, h as Empty, j as IconButton, w as Copy$1, D as Download$1, i as IconButtonWrapper } from './2-NDW0dV-l.js';
...
const lang_map = {
  python: () => import('./index28-DArd0iJJ.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index29-D3_v7nXo.js'),
      import('./frontmatter-BSJFnX1Q.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index33-DZh-mpN9.js').then((m) => m.json()),
  html: () => import('./index30-CgmGQaoz.js').then((m) => m.html()),
  css: () => import('./index31-DKpuQjpd.js').then((m) => m.css()),
  javascript: () => import('./index32-qsD1z2ii.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index32-qsD1z2ii.js').then(
...
//# sourceMappingURL=Index13-CK_CCAG6.js.map
